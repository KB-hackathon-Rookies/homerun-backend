...
/** 소유권·대출 존재 검증 후 실행 상품으로 분기 위임을 본다. 안내 문구는 RateCutRightAdvisor 몫. */
class RateCutRightServiceTest {
    ...
    private final RateCutRightAdvisor advisor = mock(RateCutRightAdvisor.class);
    private final RateCutRightService service = new RateCutRightService(plans, loans, advisor);
    ...
    void should_guideByLoanProduct_whenOwnedWithLoan() {
        ...
        RateCutRightResponse expected = mock(RateCutRightResponse.class);
