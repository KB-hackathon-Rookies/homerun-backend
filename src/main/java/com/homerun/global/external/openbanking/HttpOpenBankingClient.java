...
@Component
public class HttpOpenBankingClient implements OpenBankingClient {
    ...
    HttpOpenBankingClient(
            OpenBankingProperties properties, ObjectMapper objectMapper, Clock clock, RestClient restClient) {
