...
public record PropertyComparisonResponse(
        List<PropertyCandidateResponse> properties, List<PropertyConsultationSummaryResponse> consultationSummaries) {

    public PropertyComparisonResponse {
        properties = List.copyOf(properties);
        consultationSummaries = List.copyOf(consultationSummaries);
    }
}
