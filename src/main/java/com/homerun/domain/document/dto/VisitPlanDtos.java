...
public final class VisitPlanDtos {
    ...
    public record VisitPlanRequest(
            @NotEmpty(message = "서류를 하나 이상 지정해야 한다") List<String> documentCodes, Boolean preferOnline) {
    ...
    public record VisitPlan(
            List<VisitTask> onlineDocuments, List<AgencyVisit> visits, List<String> unknownCodes, int totalFee) {
