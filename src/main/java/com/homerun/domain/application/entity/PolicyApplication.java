package com.homerun.domain.application.entity;
...
public class PolicyApplication {
    ...
    public void changeStatus(ApplicationStatus next, Instant now) {
        ...
        // 결과 상태가 아닌 곳으로 되돌리면 이전 결과를 지운다. 남겨 두면 SCREENING 인데
        // 거절 사유가 함께 응답돼 상태와 내용이 모순된다.
    ...
    /** 이 신청 건이 해당 계획의 것인지. 경로의 planId 만 믿으면 남의 건을 고칠 수 있다. */
    public boolean belongsTo(Long planId) {
        return this.planId.equals(planId);
    }

    public void recordApproval(Long amount, BigDecimal rate) {
